...
const dict: Record<string, Record<string, string>> = {
  ...
  // features
  "features.onlineDiscount": t("Up to 7% OFF Online", "Jusqu'à 7% en ligne", "خصم 8% أونلاين", "Hasta 8% en línea", "До 8% онлайн", "Bis zu 8% online", "在线最高8%折扣", "オンライン最大8%オフ", "온라인 최대 8% 할인", "Tot 8% online"),
