      ...
      const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: `You are an expert horologist (watch specialist) for "ale LifeStyle" luxury watch store. You help customers with watch sizing and fit advice.
      ...
      const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: `You are an expert horologist for "ale LifeStyle". Answer questions about watch care, maintenance, sizing, and technical details. Be concise and professional.`
            },
